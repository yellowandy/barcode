srcdir = /home/andreas/Downloads/php-5.3.6/ext/barcode
builddir = /home/andreas/Downloads/php-5.3.6/ext/barcode
top_srcdir = /home/andreas/Downloads/php-5.3.6/ext/barcode
top_builddir = /home/andreas/Downloads/php-5.3.6/ext/barcode
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = nawk
BARCODE_SHARED_LIBADD = -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lzbar -lpng
shared_objects_barcode = barcode.lo
PHP_PECL_EXTENSION = barcode
PHP_MODULES = $(phplibdir)/barcode.la
PHP_ZEND_EX =
...
prefix = /usr/local
phplibdir = /home/andreas/Downloads/php-5.3.6/ext/barcode/modules
